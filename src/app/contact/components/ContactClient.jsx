        ...
        >
          ...
          <div className="space-y-6">
             <div>
               ...
               <a href="mailto:hello@capture.com" className="font-serif italic text-xl text-[#8b7355] hover:text-gray-800 transition-colors">hello@capture.com</a>
             </div>
             <div>
               <p className="text-xs uppercase tracking-[0.2em] text-gray-400 mb-1">Phone</p>
               <a href="tel:+1234567890" className="font-serif italic text-xl text-[#8b7355] hover:text-gray-800 transition-colors">+1 234 567 890</a>
             </div>
          </div>
          ...
          <div className="pt-8">
            ...
            <div className="flex gap-4">
               {/* Instagram */}
               <a href="#" className="w-12 h-12 rounded-full border border-[#8b7355]/30 flex items-center justify-center text-[#8b7355] hover:bg-[#8b7355] hover:text-white transition-all duration-300">
